...
const unisWithUni = graduates.filter((graduate) => graduate.university.contains("Uni"));
...
function lowerNames(){
  ...
  const mappedNames = zooAnimals.map((animal_name) => {
    return {`animal_name` : zooAnimals.animal_name};
  });
